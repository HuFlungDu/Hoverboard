...
includes = ["json","simplejson","httplib","email","pkg_resources","gzip","hmac","multipart"]
excludes = ['_gtkagg', '_tkagg', 'bsddb', 'curses', 'pywin.debugger',
            'pywin.debugger.dbgcon', 'pywin.dialogs', 'tcl',
            'Tkconstants', 'Tkinter',"plugins"]
packages = []
...
bitmap_resources = []
other_resources = []
other_resources = [(24, 1, MANIFEST_TEMPLATE % dict(prog="Hoverboard"))]
...
GUI2Exe_Target_1 = Target(
    # what to build
    script = "hoverboard.py",
    icon_resources = icon_resources,
    bitmap_resources = bitmap_resources,
    other_resources = other_resources,
    dest_base = "hoverboard",
    version = "0.1",
